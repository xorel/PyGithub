...
class Repository(_bgo.UpdatableGithubObject):
    ...
    def create_file(self, path, message, content, branch=None, author=None, committer=None):
        ...
        return _rcv.StructureReturnValue(self.Session, Repository.ContentCommit)(None, r.json())
    ...
    def create_git_blob(self, content, encoding):
        ...
        return _rcv.ClassReturnValue(self.Session, PyGithub.Blocking.GitBlob.GitBlob)(None, r.json())
    ...
    def create_git_commit(self, message, tree, parents, committer=None, author=None):
        ...
        r = self.Session._request("POST", url, postArguments=postArguments)
        return _rcv.ClassReturnValue(self.Session, PyGithub.Blocking.GitCommit.GitCommit)(None, r.json(), r.headers.get("ETag"))
    ...
    def create_git_ref(self, ref, sha):
        ...
        r = self.Session._request("POST", url, postArguments=postArguments)
        return _rcv.ClassReturnValue(self.Session, PyGithub.Blocking.GitRef.GitRef)(None, r.json(), r.headers.get("ETag"))
    ...
    def create_git_tag(self, tag, message, object, type, tagger=None):
        ...
        r = self.Session._request("POST", url, postArguments=postArguments)
        return _rcv.ClassReturnValue(self.Session, PyGithub.Blocking.GitTag.GitTag)(None, r.json(), r.headers.get("ETag"))
    ...
    def create_git_tree(self, tree):
        ...
        r = self.Session._request("POST", url, postArguments=postArguments)
        return _rcv.ClassReturnValue(self.Session, PyGithub.Blocking.GitTree.GitTree)(None, r.json(), r.headers.get("ETag"))
    ...
    def create_key(self, title, key):
        ...
        r = self.Session._request("POST", url, postArguments=postArguments)
        return _rcv.ClassReturnValue(self.Session, PyGithub.Blocking.PublicKey.PublicKey)(None, r.json(), r.headers.get("ETag"))
    ...
    def create_label(self, name, color):
        ...
        r = self.Session._request("POST", url, postArguments=postArguments)
        return _rcv.ClassReturnValue(self.Session, PyGithub.Blocking.Label.Label)(None, r.json(), r.headers.get("ETag"))
    ...
    def create_milestone(self, title, state=None, description=None, due_on=None):
        ...
        r = self.Session._request("POST", url, postArguments=postArguments)
        return _rcv.ClassReturnValue(self.Session, PyGithub.Blocking.Milestone.Milestone)(None, r.json(), r.headers.get("ETag"))
    ...
    def create_release(self, tag_name, target_commitish=None, name=None, body=None, draft=None, prerelease=None):
        ...
        r = self.Session._request("POST", url, postArguments=postArguments)
        return _rcv.ClassReturnValue(self.Session, PyGithub.Blocking.Release.Release)(None, r.json(), r.headers.get("ETag"))
    ...
    def get_branch(self, branch):
        ...
        return _rcv.StructureReturnValue(self.Session, Repository.Branch)(None, r.json())
    ...
    def get_branches(self, per_page=None):
        ...
        urlArguments = _snd.dictionary(per_page=per_page)
        r = self.Session._request("GET", url, urlArguments=urlArguments)
        return _rcv.PaginatedListReturnValue(self.Session, _rcv.StructureReturnValue(self.Session, Repository.Branch))(None, r)
    ...
    def get_commit(self, sha):
        ...
        r = self.Session._request("GET", url)
        return _rcv.ClassReturnValue(self.Session, PyGithub.Blocking.Commit.Commit)(None, r.json(), r.headers.get("ETag"))
    ...
    def get_commits(self, sha=None, path=None, author=None, since=None, until=None, per_page=None):
        ...
        r = self.Session._request("GET", url, urlArguments=urlArguments)
        return _rcv.PaginatedListReturnValue(self.Session, _rcv.ClassReturnValue(self.Session, PyGithub.Blocking.Commit.Commit))(None, r)
    ...
    def get_contributors(self, anon=None, per_page=None):
        ...
        r = self.Session._request("GET", url, urlArguments=urlArguments)
        return _rcv.PaginatedListReturnValue(self.Session, _rcv.KeyedStructureUnionReturnValue("type", dict(Anonymous=_rcv.StructureReturnValue(self.Session, Repository.AnonymousContributor), User=_rcv.ClassReturnValue(self.Session, PyGithub.Blocking.Contributor.Contributor))))(None, r)
    ...
    def get_forks(self, sort=None, per_page=None):
        ...
        r = self.Session._request("GET", url, urlArguments=urlArguments)
        return _rcv.PaginatedListReturnValue(self.Session, _rcv.ClassReturnValue(self.Session, Repository))(None, r)
    ...
    def get_git_blob(self, sha):
        ...
        r = self.Session._request("GET", url)
        return _rcv.ClassReturnValue(self.Session, PyGithub.Blocking.GitBlob.GitBlob)(None, r.json(), r.headers.get("ETag"))
    ...
    def get_git_refs(self, per_page=None):
        ...
        urlArguments = _snd.dictionary(per_page=per_page)
        r = self.Session._request("GET", url, urlArguments=urlArguments)
        return _rcv.PaginatedListReturnValue(self.Session, _rcv.ClassReturnValue(self.Session, PyGithub.Blocking.GitRef.GitRef))(None, r)
    ...
    def get_issues(self, milestone=None, state=None, assignee=None, creator=None, mentioned=None, labels=None, sort=None, direction=None, since=None, per_page=None):
        ...
        r = self.Session._request("GET", url, urlArguments=urlArguments)
        return _rcv.PaginatedListReturnValue(self.Session, _rcv.ClassReturnValue(self.Session, PyGithub.Blocking.Issue.Issue))(None, r)
    ...
    def get_keys(self):
        ...
        url = uritemplate.expand(self.keys_url)
        r = self.Session._request("GET", url)
        return _rcv.ListReturnValue(_rcv.ClassReturnValue(self.Session, PyGithub.Blocking.PublicKey.PublicKey))(None, r.json())
    ...
    def get_latest_pages_build(self):
        ...
        r = self.Session._request("GET", url)
        return _rcv.ClassReturnValue(self.Session, PyGithub.Blocking.PagesBuild.PagesBuild)(None, r.json(), r.headers.get("ETag"))
    ...
    def get_milestones(self, state=None, sort=None, direction=None, per_page=None):
        ...
        r = self.Session._request("GET", url, urlArguments=urlArguments)
        return _rcv.PaginatedListReturnValue(self.Session, _rcv.ClassReturnValue(self.Session, PyGithub.Blocking.Milestone.Milestone))(None, r)
    ...
    def get_pages(self):
        ...
        r = self.Session._request("GET", url)
        return _rcv.ClassReturnValue(self.Session, PyGithub.Blocking.PagesInformation.PagesInformation)(None, r.json(), r.headers.get("ETag"))
    ...
    def get_pages_builds(self, per_page=None):
        ...
        urlArguments = _snd.dictionary(per_page=per_page)
        r = self.Session._request("GET", url, urlArguments=urlArguments)
        return _rcv.PaginatedListReturnValue(self.Session, _rcv.ClassReturnValue(self.Session, PyGithub.Blocking.PagesBuild.PagesBuild))(None, r)
    ...
    def get_pulls(self, state=None, head=None, base=None, sort=None, direction=None, per_page=None):
        ...
        r = self.Session._request("GET", url, urlArguments=urlArguments)
        return _rcv.PaginatedListReturnValue(self.Session, _rcv.ClassReturnValue(self.Session, PyGithub.Blocking.PullRequest.PullRequest))(None, r)
    ...
    def get_readme(self, ref=None):
        ...
        urlArguments = _snd.dictionary(ref=ref)
        r = self.Session._request("GET", url, urlArguments=urlArguments)
        return _rcv.ClassReturnValue(self.Session, PyGithub.Blocking.File.File)(None, r.json(), r.headers.get("ETag"))
    ...
    def get_release_asset(self, id):
        ...
        r = self.Session._request("GET", url)
        return _rcv.ClassReturnValue(self.Session, PyGithub.Blocking.Asset.Asset)(None, r.json(), r.headers.get("ETag"))
    ...
    def get_releases(self, per_page=None):
        ...
        urlArguments = _snd.dictionary(per_page=per_page)
        r = self.Session._request("GET", url, urlArguments=urlArguments)
        return _rcv.PaginatedListReturnValue(self.Session, _rcv.ClassReturnValue(self.Session, PyGithub.Blocking.Release.Release))(None, r)
    ...
    def get_tags(self, per_page=None):
        ...
        urlArguments = _snd.dictionary(per_page=per_page)
        r = self.Session._request("GET", url, urlArguments=urlArguments)
        return _rcv.PaginatedListReturnValue(self.Session, _rcv.StructureReturnValue(self.Session, Repository.Tag))(None, r)
    ...
    def get_teams(self, per_page=None):
        ...
        urlArguments = _snd.dictionary(per_page=per_page)
        r = self.Session._request("GET", url, urlArguments=urlArguments)
        return _rcv.PaginatedListReturnValue(self.Session, _rcv.ClassReturnValue(self.Session, PyGithub.Blocking.Team.Team))(None, r)
