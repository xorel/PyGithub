...
class UserFollowing(TestCase):
    def testGetFollowing(self):
        u = self.user2.get_user("ghe-user-1")
    ...
    def testGetFollowers(self):
        u = self.user2.get_user("ghe-user-3")
    ...
    def testHasInFollowing(self):
        self.assertTrue(self.user2.get_user("ghe-user-1").has_in_following("ghe-user-3"))
        self.assertFalse(self.user2.get_user("ghe-user-3").has_in_following("ghe-user-1"))
...
class UserOrganizations(TestCase):
    ...
    def testGetSelfOrgs_allParameters(self):
        u = self.user1.get_user("ghe-user-1")
...
class UserRepositories(TestCase):
    def testGetRepo(self):
        r = self.user2.get_user("ghe-user-1").get_repo("repo-user-1-1")
