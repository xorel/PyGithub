...
class OnePageTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.content.expect("a").andReturn(5)
        self.content.expect("b").andReturn(10)
        self.content.expect("c").andReturn(15)
...
class PaginationTestCase(unittest.TestCase):
    ...
    def testGrow(self):
        ...
        self.content.expect("d").andReturn(20)
        self.content.expect("e").andReturn(25)
        self.content.expect("f").andReturn(30)
        self.response.expect.links.andReturn(dict())
    ...
    def testGrowToMaximumForUnboundedIteration(self):
        ...
        self.content.expect("g").andReturn(35)
        self.content.expect("h").andReturn(40)
        self.content.expect("i").andReturn(45)
        self.response.expect.links.andReturn(dict())
