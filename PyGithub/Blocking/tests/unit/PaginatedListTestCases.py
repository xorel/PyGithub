...
class OnePageTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.content.expect(None, "a").andReturn(5)
        self.content.expect(None, "b").andReturn(10)
        self.content.expect(None, "c").andReturn(15)
        self.response.expect.links.andReturn(dict())
        self.list = pgl.PaginatedList(self.session.object, self.content.object, self.response.object)
...
class PaginationTestCase(unittest.TestCase):
    ...
    def testGrow(self):
        ...
        self.content.expect(None, "d").andReturn(20)
        self.content.expect(None, "e").andReturn(25)
        self.content.expect(None, "f").andReturn(30)
        self.response.expect.links.andReturn(dict())
    ...
    def testGrowToMaximumForUnboundedIteration(self):
        ...
        self.content.expect(None, "g").andReturn(35)
        self.content.expect(None, "h").andReturn(40)
        self.content.expect(None, "i").andReturn(45)
        self.response.expect.links.andReturn(dict())
