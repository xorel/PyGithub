...
class TeamTestCase(TestCase):
    def testAttributes(self):
        t = self.dotcom4.get_team(141487)
    ...
    def testImpossibleToEditNameOfOwnersTeam(self):
        team = self.dotcom4.get_team(141487)
    ...
    def testEditName(self):
        ...
        team = self.dotcom4.get_team(141496)
    ...
    def testGetMembers(self):
        members = self.dotcom4.get_team(141487).get_members()
        self.assertEqual(members[0].login, "jacquev6")

    def testGetMembers_allParameters(self):
        members = self.dotcom4.get_team(141487).get_members(per_page=3)
        self.assertEqual(members[0].login, "jacquev6")
    ...
    def testGetRepos(self):
        repos = self.dotcom4.get_team(141487).get_repos()
        self.assertEqual(repos[0].full_name, "BeaverSoftware/FatherBeaver")

    def testGetRepos_allParameters(self):
        repos = self.dotcom4.get_team(141487).get_repos(per_page=1)
        self.assertEqual(repos[0].full_name, "BeaverSoftware/FatherBeaver")
