...
class CheckerTestCase(unittest.TestCase):
    ...
    def testNotUpdatableStructureIsAttributeOfClass(self):
        d = Structured.Definition(
            (),
            (
                Structured.Class("Foo", None, (Structured.Structure("Stru", False, (), ()),), (Structured.Attribute("url", Structured.ScalarType("string"), None), Structured.Attribute("attr", Structured.ScalarType("Foo.Stru"), None)), (), ()),
            ),
            ()
        )
    ...
    def testImplementedEndPoint(self):
        d = Structured.Definition(
            ...
            (
                Structured.Class("Bar", None, (), (Structured.Attribute("url", Structured.ScalarType("string"), None),), (Structured.Method("get_foo", None, ("GET /foo",), (), (), Structured.EndPointValue(), (), (), (), (), (), None, Structured.NoneType),), ()),
            ),
            ()
        )
        self.expect(d)
    ...
    def testUnusedParameter(self):
        d = Structured.Definition(
            ...
            (
                Structured.Class("Bar", None, (), (Structured.Attribute("url", Structured.ScalarType("string"), None),), (Structured.Method("get_foo", None, ("GET /foo",), (Structured.Parameter("bar", Structured.ScalarType("string"), False, False),), (), Structured.EndPointValue(), (), (), (), (), (), None, Structured.NoneType),), ()),
            ),
            ()
        )
    ...
    def testParameterUsedAsUrlTemplateArgument(self):
        d = Structured.Definition(
            ...
            (
                Structured.Class("Bar", None, (), (Structured.Attribute("url", Structured.ScalarType("string"), None),), (Structured.Method("get_foo", None, ("GET /foo",), (Structured.Parameter("bar", Structured.ScalarType("string"), False, False),), (), Structured.EndPointValue(), (Structured.Argument("baz", Structured.ParameterValue("bar",)),), (), (), (), (), None, Structured.NoneType),), ()),
            ),
            ()
        )
        self.expect(d)
    ...
    def testParameterUsedAsRepoOwnerInUrlTemplateArgument(self):
        d = Structured.Definition(
            ...
            (
                Structured.Class("Bar", None, (), (Structured.Attribute("url", Structured.ScalarType("string"), None),), (Structured.Method("get_foo", None, ("GET /foo",), (Structured.Parameter("bar", Structured.ScalarType("string"), False, False),), (), Structured.EndPointValue(), (Structured.Argument("baz", Structured.RepositoryOwnerValue("bar",)),), (), (), (), (), None, Structured.NoneType),), ()),
            ),
            ()
        )
        self.expect(d)
    ...
    def testParameterUsedAsRepoNameInUrlTemplateArgument(self):
        d = Structured.Definition(
            ...
            (
                Structured.Class("Bar", None, (), (Structured.Attribute("url", Structured.ScalarType("string"), None),), (Structured.Method("get_foo", None, ("GET /foo",), (Structured.Parameter("bar", Structured.ScalarType("string"), False, False),), (), Structured.EndPointValue(), (Structured.Argument("baz", Structured.RepositoryNameValue("bar",)),), (), (), (), (), None, Structured.NoneType),), ()),
            ),
            ()
        )
        self.expect(d)
    ...
    def testUnimplementedEndPointParameterDeclared(self):
        d = Structured.Definition(
            ...
            (
                Structured.Class("Bar", None, (), (Structured.Attribute("url", Structured.ScalarType("string"), None),), (Structured.Method("get_foo", None, ("GET /foo",), (), (Structured.UnimplementedStuff("bar", "reason"),), Structured.EndPointValue(), (), (), (), (), (), None, Structured.NoneType),), ()),
            ),
            ()
        )
        self.expect(d)
    ...
    def testImplementedEndPointParameterDeclaredAsUnimplemented(self):
        d = Structured.Definition(
            ...
            (
                Structured.Class("Bar", None, (), (Structured.Attribute("url", Structured.ScalarType("string"), None),), (Structured.Method("get_foo", None, ("GET /foo",), (Structured.Parameter("bar", Structured.ScalarType("string"), False, False),), (Structured.UnimplementedStuff("bar", "reason"),), Structured.EndPointValue(), (), (Structured.Argument("baz", Structured.ParameterValue("bar",)),), (), (), (), None, Structured.NoneType),), ()),
            ),
            ()
        )
    ...
    def testOderedEndPointParameter(self):
        d = Structured.Definition(
            ...
            (
                Structured.Class("Bar", None, (), (Structured.Attribute("url", Structured.ScalarType("string"), None),), (Structured.Method("get_foo", None, ("GET /foo",), (Structured.Parameter("c", Structured.ScalarType("string"), False, False), Structured.Parameter("b", Structured.ScalarType("string"), False, False)), (Structured.UnimplementedStuff("a", "reason"),), Structured.EndPointValue(), (), (Structured.Argument("baz", Structured.ParameterValue("b")), Structured.Argument("foo", Structured.ParameterValue("c"))), (), (), (), None, Structured.NoneType),), ()),
            ),
            ()
        )
        self.expect(d)
    ...
    def testUnoderedEndPointParameter(self):
        d = Structured.Definition(
            ...
            (
                Structured.Class("Bar", None, (), (Structured.Attribute("url", Structured.ScalarType("string"), None),), (Structured.Method("get_foo", None, ("GET /foo",), (Structured.Parameter("b", Structured.ScalarType("string"), False, False), Structured.Parameter("c", Structured.ScalarType("string"), False, False)), (Structured.UnimplementedStuff("a", "reason"),), Structured.EndPointValue(), (), (Structured.Argument("baz", Structured.ParameterValue("b")), Structured.Argument("foo", Structured.ParameterValue("c"))), (), (), (), None, Structured.NoneType),), ()),
            ),
            ()
        )
    ...
    def testUnexistingParameterUsedAsUrlTemplateArgument(self):
        d = Structured.Definition(
            ...
            (
                Structured.Class("Bar", None, (), (Structured.Attribute("url", Structured.ScalarType("string"), None),), (Structured.Method("get_foo", None, ("GET /foo",), (), (), Structured.EndPointValue(), (Structured.Argument("baz", Structured.ParameterValue("bar",)),), (), (), (), (), None, Structured.NoneType),), ()),
            ),
            ()
        )
    ...
    def testAttributeHidesAttributeOfBase(self):
        d = Structured.Definition(
            (),
            (
                Structured.Class("Foo", None, (), (Structured.Attribute("slug", Structured.ScalarType("string"), None),), (), ()),
                Structured.Class("Bar", Structured.ScalarType("Foo"), (), (Structured.Attribute("slug", Structured.ScalarType("string"), None),), (), ()),
            ),
            ()
        )
    ...
    def testAttributeHidesAttributeOfIndirectBase(self):
        d = Structured.Definition(
            ...
            (
                ...
                Structured.Class("Baz", Structured.ScalarType("Bar"), (), (Structured.Attribute("slug", Structured.ScalarType("string"), None),), (), ()),
            ),
            ()
        )
    ...
    def testMethodHidesMethodOfBase(self):
        d = Structured.Definition(
            ...
            (
                Structured.Class("Foo", None, (), (), (Structured.Method("get_foo", None, ("GET /foo",), (), (), Structured.EndPointValue(), (), (), (), (), (), None, Structured.NoneType),), ()),
                Structured.Class("Bar", Structured.ScalarType("Foo"), (), (), (Structured.Method("get_foo", None, ("GET /foo",), (), (), Structured.EndPointValue(), (), (), (), (), (), None, Structured.NoneType),), ()),
            ),
            ()
        )
    ...
    def testMethodHidesMethodOfIndirectBase(self):
        d = Structured.Definition(
            ...
            (
                Structured.Class("Foo", None, (), (), (Structured.Method("get_foo", None, ("GET /foo",), (), (), Structured.EndPointValue(), (), (), (), (), (), None, Structured.NoneType),), ()),
                Structured.Class("Bar", Structured.ScalarType("Foo"), (), (), (), ()),
                Structured.Class("Baz", Structured.ScalarType("Bar"), (), (), (Structured.Method("get_foo", None, ("GET /foo",), (), (), Structured.EndPointValue(), (), (), (), (), (), None, Structured.NoneType),), ()),
            ),
            ()
        )
    ...
    def testUrlAttributeNotUsed(self):
        d = Structured.Definition(
            (),
            (
                Structured.Class("Foo", None, (), (Structured.Attribute("slug_url", Structured.ScalarType("string"), None),), (), ()),
            ),
            ()
        )
    ...
    def testUrlAttributeUsed(self):
        d = Structured.Definition(
            ...
            (
                Structured.Class("Foo", None, (), (Structured.Attribute("slug_url", Structured.ScalarType("string"), None),), (Structured.Method("get_slug", None, ("GET /slug",), (), (), Structured.AttributeValue("slug_url"), (), (), (), (), (), None, Structured.NoneType),), ()),
            ),
            ()
        )
        self.expect(d)
    ...
    def testClassWithMethodsInheritsMethod(self):
        d = Structured.Definition(
            ...
            (
                Structured.Class("Foo", None, (), (), (Structured.Method("get_foo", None, ("GET /foo",), (), (), Structured.EndPointValue(), (), (), (), (), (), None, Structured.NoneType),), ()),
                Structured.Class("Bar", Structured.ScalarType("Foo"), (), (), (Structured.Method("get_bar", None, ("GET /foo",), (), (), Structured.EndPointValue(), (), (), (), (), (), None, Structured.NoneType),), ()),
            ),
            ()
        )
